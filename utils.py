...
def fit(model, epochs, trainloader, testloader, save_path, save_pickle):
    ...
    for epoch in range(epochs):
        running_loss, running_accuracy = train(epoch, epochs, model, trainloader, criterion, optimizer, scheduler)

        train_accs.append(running_accuracy)
        train_losses.append(running_loss)

        test_loss, test_accuracy = evaluation(epoch, epochs, model, testloader, criterion)
    ...
    pickle.dump([train_accs, test_accs, train_losses, test_losses], open(f'{save_path}.pkl', 'wb'))
